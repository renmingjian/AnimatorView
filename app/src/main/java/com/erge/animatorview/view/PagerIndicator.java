...
/**
 * Created by erge 4/15/21 2:39 PM
 */
public class PagerIndicator extends ScrollingPagerIndicator {
    ...
    private ScrollingPagerIndicator.PagerAttacher<?> currentAttacher;
     ...
     */
    @ScrollingPagerIndicator.Orientation
     ...
     */
    public void setOrientation(@ScrollingPagerIndicator.Orientation int orientation) {
     ...
     */
    public <T> void attachToPager(@NonNull final T pager, @NonNull final ScrollingPagerIndicator.PagerAttacher<T> attacher) {
        detachFromPager();
    ...
    private void initDots(int itemCount) {
        ...
        firstDotOffset = looped && this.itemCount > visibleDotCount ? 1 : dotSelectedSize / 2 + 1;
