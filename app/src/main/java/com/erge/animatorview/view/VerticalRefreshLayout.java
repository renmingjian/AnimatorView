...
/**
 * Created by erge 1/13/21 11:11 AM
 */
public class VerticalRefreshLayout extends FrameLayout {
    ...
    private void obtainAttrs(AttributeSet attrs) {
        final TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.VerticalRefreshLayout);
        mIsScaleMenuView = ta.getBoolean(R.styleable.VerticalRefreshLayout_top_menu_scrollable, true);
        ta.recycle();
    }
...
//            throw new InflateException("上下滑动布局必须有且仅有两个直接的子View");
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) Utils.dp2px(40), (int) Utils.dp2px(40));
        layoutParams.topMargin = (int) Utils.dp2px(50);
...
//        open();
    ...
    public void close() {
        ...
        ViewCompat.postInvalidateOnAnimation(VerticalRefreshLayout.this);
    }
